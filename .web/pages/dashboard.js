...
import { Box, Center, Heading, HStack, Image, Link, Menu, MenuButton, MenuDivider, MenuItem, MenuList, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, NumberDecrementStepper, NumberIncrementStepper, NumberInput, NumberInputField, NumberInputStepper, Spacer, Text, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <VStack>
  <HStack>
  <Image src={`/chemex.png`} sx={{"width": "32px", "height": "32px"}}/>
  <Heading>
  {`Caffeine Calculator`}
</Heading>
</HStack>
  <Text>
  {`Check your caffeine levels -- just enter the caffeine level of the drink and the time that you plan to have it!`}
</Text>
  ...
  <meta content={`/chemex.png`} property={`og:image`}/>
